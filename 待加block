...
actorIMG = Block(0,0,0)
actorIMG.set_image("racecar.png") # 匯入主角圖片
#actorImage = pygame.load.image("racecar.png")


bg = pygame.image.load("1.1-4d046d33a07490f813867425851deff9.jpg") # 匯入地圖image
...
def game():
    ...
    #將block顯示出來
        ...
        #block_group.add(block_1, block_2, block_3,block_4)
        ...
        # 將人物顯示出來
        actorIMG.update(collidable_objects)
        screen.blit(actorIMG.image, (int(map_x + role_x), int(map_y + role_y)))
